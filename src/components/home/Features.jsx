...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Build your resume' description='Create a professional resume in minutes with our AI-powered builder. Get personalized suggestions, customizable templates, and expert tips to land your dream job.' />
